...
const BreathingCard = ({ className, title, description, image }) => {
  return (
    <div
      className={`w-full max-w-[672px] flex flex-col sm:flex-row items-start gap-4 p-4 sm:p-8 relative bg-white rounded-2xl overflow-hidden border-[none] ${className}`}
    >
      <img
